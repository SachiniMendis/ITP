   ...
   useEffect(()=>{
    ...
    return (
        <div class="col main pt-5 mt-3" >
            ...
            <div  className="head">
            <div>
              <h5 class="display-6 font-weight-bold text-black">Requests</h5></div>
              ...
              </thead>
              {
                    ...
                    <tr>
                        ...
                        <AsyncSelect
                            ...
                            (option) => option.value === selectedSuppliers[per._id]
                            )}
                        ...
                        <td>{per.product_price}</td>
                        <td>{(per.product_price)*(per.qty)}</td>
...
export default PurchaseOrder_sm;
