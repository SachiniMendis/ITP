...
<div class="container-fluid">
  ...
  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                      ...
                      <div class="d-flex mb-4" style={{maxWidth: "300px"}}>
                        <button class="btn btn-primary px-3 me-2 mr-3 mb-4" 
                         onClick={() => handleQuantityMinus(item._id, item.quantity)} style={{backgroundColor: "#f2c800"}}>
                        ...
                        <button class="btn btn-primary px-3 ms-2 ml-3 mb-4" 
                          onClick={() => handleQuantityPlus(item._id, item.quantity)}style={{backgroundColor: "#f2c800"}}>
    ...
    <div class="card mb-4">
               ...
               <div > <button type="button" onClick={NavigateToCheckout} class="btn btn-primary btn-lg " style={{backgroundColor: "#f2c800",width:"290px"}} >
                    Go to checkout
                  </button></div>
