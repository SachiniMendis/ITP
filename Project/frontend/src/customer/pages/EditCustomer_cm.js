      ...
      <div class="form-row">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="email" value={email} onChange={(event)=>setEmail(event.target.value)}  class="form-control" id="email" />
          </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" value={username} onChange={(event)=>setUsername(event.target.value)}  class="form-control" id="username" />
          </div>
