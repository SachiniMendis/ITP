...
const handleDeleteProductall=async()=>{
  ...
  await axios.delete(`${api}/cart/deleteAllItem/${JSON.parse(localStorage.getItem('customerid'))}`).then((res)=>{
...
<form class="mb-5" onSubmit={()=>{addOrder();handleDeleteProductall(JSON.parse(localStorage.getItem('customerid')))}}>
