module.exports=(order)=>{
    ...
    <div id="project">
      ...
      <div><span>Name</span>Bavantha Senanayake</div>
     ...
     ${order.map((item)=>{
       ...
       // total=total+(item.unit_price * item.unit_price)
        ...
        return(
            ...
            <td class="desc">${item.customerId}</td>
            <td class="unit">${item.productName}</td>
            <td class="unit">${item.quantity}</td>
            <td class="unit">${item.unitPrice}</td>
            <td class="unit">${item.status}</td>
