module.exports=(driver)=>{
    ...
    <div id="project">
      ...
      <div><span>Name</span>Sachini Mendis</div>
     
      <div><span>EMAIL</span> <a href="mailto:john@example.com">sachini@gmail.com</a></div>
  ...
  <main>
    <table>
     ...
     ${driver.map((per)=>{
        ...
        return(
            `   <tr>
            <td class="service">${per.Drivername}</td>
            <td class="desc">${per.Contact}</td>
            <td class="unit">${per.VehicleType}</td>
            <td class="unit">${per.LicenseNo}</td>
            <td class="unit">${per.VehicleNo}</td>
