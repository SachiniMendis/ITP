...
module.exports=(employee)=>{
    ...
    <h1>Employee Attendance Stock</h1>
    ...
    <div id="project">
      ...
      <div><span>Name</span>Sansala Silva</div>
     
      <div><span>EMAIL</span> <a href="mailto:john@example.com">toolhub@gmail.com</a></div>
  ...
  <main>
    <table>
      <thead>
        <tr>
          <th class="service">Employee Name</th>
          <th class="desc">Nic</th>
          <th>Position</th>
          <th>Duty on Time</th>
     ...
     ${employee.map((item)=>{
        ...
        return(
            ...
            <td class="service">${item.nic}</td>
            <td class="desc">${item.position}</td>
            <td class="unit">${item.time}</td>
